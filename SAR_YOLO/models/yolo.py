...
class SegmentationModel(DetectionModel):
    ...
    def __init__(self, cfg="yolov5s-seg.yaml", ch=3, nc=None, anchors=None):
        """Initializes a YOLOv5 segmentation model with configurable params: cfg (str) for configuration,
        ch (int) for channels, nc (int) for num classes, anchors (list)."""
...
if __name__ == "__main__":
    ...
    fh = logging.FileHandler('model_summary.log', mode='w', encoding='utf-8')
